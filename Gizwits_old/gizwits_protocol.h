...
* @{
*/
#define PRODUCT_KEY "a78d3e06bf614717a73c9d37c018c434"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "7521df977da148969b984f7c8b966ea2"
...
* @{
*/
#define beep_flag_BYTEOFFSET                    0
#define beep_flag_BITOFFSET                     0
#define beep_flag_LEN                           1
#define tmp_flag_BYTEOFFSET                    13
#define tmp_flag_BITOFFSET                     0
#define tmp_flag_LEN                           1
#define hum_flag_BYTEOFFSET                    13
#define hum_flag_BITOFFSET                     1
#define hum_flag_LEN                           1
#define fire_flag_BYTEOFFSET                    13
#define fire_flag_BITOFFSET                     2
#define fire_flag_LEN                           1
#define smoke_flag_BYTEOFFSET                    13
#define smoke_flag_BITOFFSET                     3
#define smoke_flag_LEN                           1

#define tmp_threshold_RATIO                         1
#define tmp_threshold_ADDITION                      0
#define tmp_threshold_MIN                           0
#define tmp_threshold_MAX                           50
#define hum_threshold_RATIO                         1
#define hum_threshold_ADDITION                      0
#define hum_threshold_MIN                           0
#define hum_threshold_MAX                           100
#define fire_threshold_RATIO                         1
#define fire_threshold_ADDITION                      0
#define fire_threshold_MIN                           0
#define fire_threshold_MAX                           500
#define mq2_threshold_RATIO                         1
#define mq2_threshold_ADDITION                      0
#define mq2_threshold_MIN                           0
#define mq2_threshold_MAX                           500
#define hum_data_RATIO                         1
#define hum_data_ADDITION                      0
#define hum_data_MIN                           0
#define hum_data_MAX                           100
#define tmp_data_RATIO                         1
#define tmp_data_ADDITION                      0
#define tmp_data_MIN                           0
#define tmp_data_MAX                           50
#define fire_data_RATIO                         1
#define fire_data_ADDITION                      0
#define fire_data_MIN                           0
#define fire_data_MAX                           500
#define mq2_data_RATIO                         1
#define mq2_data_ADDITION                      0
#define mq2_data_MIN                           0
#define mq2_data_MAX                           500
/**@} */
...
typedef struct {
  bool valuebeep_flag;
  uint32_t valuetmp_threshold;
  uint32_t valuehum_threshold;
  uint32_t valuefire_threshold;
  uint32_t valuemq2_threshold;
  uint32_t valuehum_data;
  uint32_t valuetmp_data;
  uint32_t valuefire_data;
  uint32_t valuemq2_data;
  bool valuetmp_flag;
  bool valuehum_flag;
  bool valuefire_flag;
  bool valuesmoke_flag;
} dataPoint_t;


/** Corresponding to the protocol "4.10 WiFi module control device" in the flag " attr_flags" */ 
typedef struct {
  uint8_t flagbeep_flag:1;
  uint8_t flagtmp_threshold:1;
  uint8_t flaghum_threshold:1;
  uint8_t flagfire_threshold:1;
  uint8_t flagmq2_threshold:1;
} attrFlags_t;
...
typedef struct {
  ...
  uint8_t valuetmp_threshold;
  uint8_t valuehum_threshold;
  uint16_t valuefire_threshold;
  uint16_t valuemq2_threshold;
} attrVals_t;
...
typedef struct {
  ...
  uint16_t valuefire_threshold;
  uint16_t valuemq2_threshold;
  uint8_t valuehum_data;
  uint8_t valuetmp_data;
  uint16_t valuefire_data;
  uint16_t valuemq2_data;
